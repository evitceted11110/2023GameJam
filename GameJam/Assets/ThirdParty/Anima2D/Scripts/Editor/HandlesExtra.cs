	...
	public class HandlesExtra
	{
		...
		public class Styles
		{
			...
			public Styles()
			{
				...
				dotCyan.normal.background = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/ThirdParty/Anima2D/Resources/dotCyan.png", typeof(Texture2D));

                dotYellow.fixedWidth = 8f;
				dotYellow.fixedHeight = 8f;
				dotYellow.normal.background = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/ThirdParty/Anima2D/Resources/dotYellow.png", typeof(Texture2D));

                dotRed.fixedWidth = 8f;
				dotRed.fixedHeight = 8f;
				dotRed.normal.background = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/ThirdParty/Anima2D/Resources/dotRed.png", typeof(Texture2D));

                dotBlackBig.fixedWidth = 23.5f;
				dotBlackBig.fixedHeight = 23.5f;
				dotBlackBig.normal.background = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/ThirdParty/Anima2D/Resources/dotBlackBig.png", typeof(Texture2D));

                dotYellowBig.fixedWidth = 23.5f;
				dotYellowBig.fixedHeight = 23.5f;
				dotYellowBig.normal.background = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/ThirdParty/Anima2D/Resources/dotYellowBig.png", typeof(Texture2D));
