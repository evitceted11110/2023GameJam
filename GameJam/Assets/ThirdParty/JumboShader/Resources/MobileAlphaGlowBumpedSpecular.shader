Shader "Yile/MobileAlphaGlowBumpedSpecular" {
	Properties{
	...
	SubShader{
		...
		CGPROGRAM
		#pragma surface surf MobileBlinnPhong alpha exclude_path:prepass nolightmap noforwardadd halfasview interpolateview
		//#pragma target 3.0
