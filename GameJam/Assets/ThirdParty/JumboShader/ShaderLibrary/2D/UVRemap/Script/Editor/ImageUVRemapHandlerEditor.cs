...
[CustomEditor(typeof(ImageUVRemapHandler))]
public class ImageUVRemapHandlerEditor : Editor
{
    private ImageUVRemapHandler handler;
    ...
    Vector2 Draw(Vector2 point)
    {
        ...
        Vector2 newPos = Handles.FreeMoveHandle(point, Quaternion.identity, 10f, Vector2.zero, Handles.CylinderHandleCap);
        return newPos;
    }

    private void OnEnable()
    {
        handler = (ImageUVRemapHandler)target;
    }
