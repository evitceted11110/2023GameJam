Shader "Yile/Model/Lit/PBR_Cutout"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float3 lerpResult54 = lerp( float3(0,0,1) , UnpackNormal( tex2D( _BumpMap, uv_BumpMap ) ) , _BumpScale);
			...
			o.Emission = lerp(temp_cast_1,( fresnelNode23 * _RimColor ),_UseRim).rgb;
			...
			//R通道給Specular
			o.Specular = _Specular*PBRCol.r;

			//G通道給_Gloss
			o.Gloss = _Gloss*PBRCol.g;
